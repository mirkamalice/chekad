...
!function (a) {
    ...
    d.prototype = {
        constructor: d, init: function () {
            ...
            var a = this.$trigger.offset(), b = this.$trigger.outerHeight();
            this.$picker.css({top: a.top + b, left: a.left})
        }, show: function () {
            ...
            var a = this.$element, b = d.fn.formatDate(this.date, this.format);
            a.is("input") ? a.prop("value", b).trigger("change") : a.text(b)
        }, template: function (b) {
            var c = {text: "", type: "", selected: !1, disabled: !1};
            ...
            var a, b, c = "", d = [], e = this.defaults.yearSuffix || "", f = this.date.getFullYear(),
            ...
            var a, b, c = "", d = [], e = this.defaults.monthsShort, f = this.date.getFullYear(),
                g = this.date.getMonth(), h = this.viewDate.getFullYear();
            ...
            var b, c = [], d = this.defaults.daysMin, e = parseInt(this.defaults.weekStart, 10) % 7;
            for (d = a.merge(d.slice(e), d.slice(0, e)), b = 0; 7 > b; b++) c.push(this.template({text: d[b]}));
            this.$picker.find("[data-type='week']").empty().html(c.join(""))
        }, fillDays: function () {
            var b, c, e, f, g, h, i = "", j = [], k = [], l = [], m = [], n = this.defaults.monthsShort,
                o = this.defaults.yearSuffix || "", p = this.date.getFullYear(), q = this.date.getMonth(),
                r = this.date.getDate(), s = this.viewDate.getFullYear(), t = this.viewDate.getMonth(),
            ...
            var c, d, e, f, g, h = a(b.target), i = /^\d{2,4}$/, j = !1;
        ...
        isLeapYear: function (a) {
            ...
            var b, c, d = a.match(/[.\/\-\s].*?/) || "/", e = a.split(/\W+/);
            if (!e || 0 === e.length) throw new Error("Invalid date format.");
            for (a = {separator: d[0], parts: e}, c = 0, b = e.length; b > c; c++) switch (e[c]) {
                case"dd":
                case"d":
                    a.day = !0;
                    break;
        ...
        return this.each(function () {
            var c = a(this), e = c.data("datepicker");
