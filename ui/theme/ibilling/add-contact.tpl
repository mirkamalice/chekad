            ...
            <div class="col-md-12">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <a href="{$_url}contacts/import_csv/" class="btn btn-xs btn-primary btn-rounded pull-right"><i class="fa fa-bars"></i> وارد کردن مخاطبین</a>
                        ...
                        <form class="form-horizontal" id="rform">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group"><label class="col-md-4 control-label" for="account">{$_L['Full Name2']}<small class="red">*</small> </label>
...
{*                                    </div>*}
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group" style="display: none"><label class="col-md-4 control-label" for="currency">{$_L['Currency']}</label>
