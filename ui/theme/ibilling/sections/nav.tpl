...
{*    {if has_access($user->roleid,'leads','view')}*}
{*        <li {if $_application_menu eq 'leads'}class="active"{/if}><a href="{$_url}contacts/leads/"><i class="fa fa-building-o"></i> <span class="nav-label">{$_L['Leads']}</span></a></li>*}
{*    {/if}*}
    ...
    <li class="{if $_application_menu eq 'transactions'}active{/if}">
        <a href="#"><i class="fa fa-database"></i> <span class="nav-label">{$_L['Transactions2']}</span><span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
